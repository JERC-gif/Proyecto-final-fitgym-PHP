...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-2">Próximamente</p>
                </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Ingresos Mensuales</p>
                    <p class="text-3xl font-bold text-gray-900">$0</p>
                    <p class="text-xs text-gray-500 mt-2">Próximamente</p>
                </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1">Reportes Pendientes</p>
                    <p class="text-3xl font-bold text-gray-900">0</p>
                    <p class="text-xs text-gray-500 mt-2">Próximamente</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="space-y-3">
                <button type="button" class="w-full flex items-center justify-between p-4 text-sm font-medium text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 border border-gray-200">
        ...
        <div class="p-6 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-sm font-medium text-gray-900">Membresía renovada</p>
